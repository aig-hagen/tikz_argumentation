...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{command}{
        annotatedattack[\opt{position}]\{\opt{arg1}\}\{\opt{arg2}\}\{\opt{value}\}
    }
        \item[\opt{position}] Specifies where the annotation should be placed relative to the attack arrow and should be one of: \textsf{above}, \textsf{below}, \textsf{left}, \textsf{right}.
        \item[\opt{arg1}] Identifier of the attacking argument.
        \item[\opt{arg2}] Identifier of the attacked argument.
