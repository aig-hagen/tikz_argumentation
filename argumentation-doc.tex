...
\usepackage{doc}                                % Showing Commands (must load before tcolorbox)
...
By default, the annotation is placed above the argument node.
To adjust its position, use \texttt{xshift}/\texttt{yshift} for fine-tuning, or pass a placement key such as \texttt{below of=\mopt{argId}}, \texttt{left of=\mopt{argId}}, or \texttt{right of=\mopt{argId}} in the options to change the direction entirely.\\
