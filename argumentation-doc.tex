...
\begin{figure}[ht]
    ...
    \begin{af}
        ...
        \afname[left of=a1,yshift=-0.8cm,xshift=-0.2cm]{\afref{af:ex1}:}
...
\subsection*{[v1.3 2024/09/20]}
\begin{itemize}
    \item Added referencing to \texttt{af} environment
    \item Added commands \verb|\AF|, \verb|\arguments|, \verb|\attacks| and \verb|\AFcomplete| to allow consistent naming of AFs
    \item Added commands \verb|\afref| and \verb|\fullafref| to reference AFs
    \item adjusted scaling of nodes and arrows
    \item added new style options
\end{itemize}
