...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Documentation for Version 1.7 [2026/06/20]}\label{sec:documentation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
To attach an annotation to an attack edge, pass it as an optional argument in parentheses directly to \verb|\attack|:\\

\noindent\cs{attack [\oopt{options}] \{\mopt{argId1}\} \{\mopt{argId2}\} (\popt{annotation})}

The \popt{annotation} placement can be controlled via the options, e.\,g., \textsf{above}, \textsf{below}, \textsf{left} or \textsf{right}.

As an alternative to the standard attack arrow, you can use the following command.\\

\noindent\cs{support [\oopt{options}] \{\mopt{argId1}\} \{\mopt{argId2}\} (\popt{annotation})}
\begin{description}
    \item[\oopt{options}] (optional) a list of \tikzname style parameters.
...
\noindent\cs{setattack [\oopt{options}] \{\mopt{sourceList}\} \{\mopt{argId}\} (\popt{annotation})}
\begin{description}
    \item[\oopt{options}] (optional) a list of \tikzname style parameters.
...
\noindent\cs{setsupport [\oopt{options}] \{\mopt{sourceList}\} \{\mopt{argId}\} (\popt{annotation})}
\begin{description}
    \item[\oopt{options}] (optional) a list of \tikzname style parameters.
